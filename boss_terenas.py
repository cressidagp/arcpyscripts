...
def TirionFordring_onReachWP( unit, event, wpid, foward ):
     if wpid == 1:
          unit.emote( EMOTE_STATE_READY2H, 0 )
...
arcemu.RegisterUnitEvent( CREATUREID_TIRION_FORDRING, arcemu.CREATURE_EVENT_ON_REACH_WP, TirionFordring_onReachWP )
